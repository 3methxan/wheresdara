...
export default function FootFetish() {
  return (
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-7 lg:px-8">
        <div className="grid grid-cols-2 gap-x-12 gap-y-16 md:col-span-3 lg:grid-cols-6">
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pr-8">
            <div className="text-2xl font-bold">Where's Dara?</div>
            <p className="mt-7 text-base leading-relaxed text-muted-foreground">
              Motherfucking text right header
            </p>
          ...
          <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
            <p className="text-sm font-semibold uppercase tracking-widest text-muted-foreground">
              Subscribe to newsletter, there will never be a single email. This is for the SEO
            </p>
        ...
        <p className="text-center text-sm text-muted-foreground">
          © Copyright {new Date().getFullYear()}, All Rights Reserved, WheresDara
        </p>
      </div>
    </footer>
  );
